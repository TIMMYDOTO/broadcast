...
// Source: rpc/rpc_subscribe_stake.proto
//
...
struct Bb_Mobile_OddinTreeWs_SubscribeStakeRequest {
...
struct Bb_Mobile_OddinTreeWs_SubscribeStakeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var match: Bb_Mobile_OddinTreeWs_Match {
    get {return _match ?? Bb_Mobile_OddinTreeWs_Match()}
    set {_match = newValue}
  }
  ...
  var stake: Bb_Mobile_OddinTreeWs_Stake {
    get {return _stake ?? Bb_Mobile_OddinTreeWs_Stake()}
    set {_stake = newValue}
  }
  ...
  fileprivate var _match: Bb_Mobile_OddinTreeWs_Match? = nil
  fileprivate var _stake: Bb_Mobile_OddinTreeWs_Stake? = nil
}
...
extension Bb_Mobile_OddinTreeWs_SubscribeStakeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SubscribeStakeRequest"
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_SubscribeStakeRequest, rhs: Bb_Mobile_OddinTreeWs_SubscribeStakeRequest) -> Bool {
...
extension Bb_Mobile_OddinTreeWs_SubscribeStakeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SubscribeStakeResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "code"),
    2: .same(proto: "status"),
    3: .same(proto: "error"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._match) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._stake) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_SubscribeStakeResponse, rhs: Bb_Mobile_OddinTreeWs_SubscribeStakeResponse) -> Bool {
