...
// Source: rpc/newsletters/rpc_newsletter_stake.proto
//
...
struct Bb_Mobile_OddinTreeWs_StakeResponse {
...
extension Bb_Mobile_OddinTreeWs_StakeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".StakeResponse"
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._stake) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_StakeResponse, rhs: Bb_Mobile_OddinTreeWs_StakeResponse) -> Bool {
