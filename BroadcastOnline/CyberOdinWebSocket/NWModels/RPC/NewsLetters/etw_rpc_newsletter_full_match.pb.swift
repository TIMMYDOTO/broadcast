...
// Source: rpc/newsletters/rpc_newsletter_full_match.proto
//
...
struct Bb_Mobile_OddinTreeWs_FullMatchResponse {
...
extension Bb_Mobile_OddinTreeWs_FullMatchResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FullMatchResponse"
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_FullMatchResponse, rhs: Bb_Mobile_OddinTreeWs_FullMatchResponse) -> Bool {
