...
// Source: rpc/newsletters/rpc_newsletter_match.proto
//
...
struct Bb_Mobile_OddinTreeWs_MatchResponse {
...
extension Bb_Mobile_OddinTreeWs_MatchResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MatchResponse"
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularMessageField(value: &self._match) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_MatchResponse, rhs: Bb_Mobile_OddinTreeWs_MatchResponse) -> Bool {
