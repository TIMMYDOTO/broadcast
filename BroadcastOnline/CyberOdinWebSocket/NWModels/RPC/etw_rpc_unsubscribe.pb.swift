...
// Source: rpc/rpc_unsubscribe.proto
//
...
struct Bb_Mobile_OddinTreeWs_UnsubscribeRequest {
...
struct Bb_Mobile_OddinTreeWs_UnsubscribeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Bb_Mobile_OddinTreeWs_UnsubscribeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_UnsubscribeRequest, rhs: Bb_Mobile_OddinTreeWs_UnsubscribeRequest) -> Bool {
...
extension Bb_Mobile_OddinTreeWs_UnsubscribeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_UnsubscribeResponse, rhs: Bb_Mobile_OddinTreeWs_UnsubscribeResponse) -> Bool {
