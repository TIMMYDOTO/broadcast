...
// Source: rpc/rpc_subscribe_full_match.proto
//
...
struct Bb_Mobile_OddinTreeWs_SubscribeFullMatchRequest {
...
struct Bb_Mobile_OddinTreeWs_SubscribeFullMatchResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Bb_Mobile_OddinTreeWs_SubscribeFullMatchRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SubscribeFullMatchRequest"
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_SubscribeFullMatchRequest, rhs: Bb_Mobile_OddinTreeWs_SubscribeFullMatchRequest) -> Bool {
...
extension Bb_Mobile_OddinTreeWs_SubscribeFullMatchResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SubscribeFullMatchResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "code"),
    2: .same(proto: "status"),
    3: .same(proto: "error"),
  ...
  static func ==(lhs: Bb_Mobile_OddinTreeWs_SubscribeFullMatchResponse, rhs: Bb_Mobile_OddinTreeWs_SubscribeFullMatchResponse) -> Bool {
