...
class MainViewController2: UIViewController, MainViewInput {
    ...
    private var isStorySkeletonActive = false
...
//        tournamentsCollection.layoutIfNeeded()
    ...
    func stopStorySkeletonState() {
        isStorySkeletonActive = false
...
extension MainViewController2: InAppStoryDelegate {
...
extension MainViewController2: StoryViewDelegateFlowLayout {
